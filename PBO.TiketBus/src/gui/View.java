...
public class View extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String nik = label_nik.getText(); 
      String nama = label_nama.getText();
      String alamat = label_alamat.getText();
      String tanggal_berangkat = label_tanggal_berangkat.getText();
      String harga_tiket = label_harga_tiket.getText();
      String harga_layanan =  label_harga_layanan.getText();
      String harga_total = label_total_harga.getText();
      ...
      List <String> list_layanan = new ArrayList<>();
        ...
        String join_layanan = String.join(",", list_layanan);
        String save = nik + ".$" + nama + ".$" + alamat + ".$" + tanggal_berangkat + ".$" + berangkat + ".$" + kelas + ".$" 
                + join_layanan + ".$" + harga_tiket + ".$" + harga_layanan + ".$" + harga_total;
